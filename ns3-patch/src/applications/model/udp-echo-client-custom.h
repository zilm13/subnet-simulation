...
#ifndef UDP_ECHO_CLIENT_CUSTOM_H
#define UDP_ECHO_CLIENT_CUSTOM_H
...
/**
 * \ingroup udpecho
 * \brief A Udp Echo client with callback
 *
 * Every packet sent should be returned by the server and received here.
 */
class UdpEchoClientCustom : public Application
{
public:
  /**
   ...
   * TODO: description
   */
  void SetPythonCallback (PythonCallback callback);
...
private:
  ...
  PythonCallback m_callback; // TODO: description
...
#endif /* UDP_ECHO_CLIENT_CUSTOM_H */
